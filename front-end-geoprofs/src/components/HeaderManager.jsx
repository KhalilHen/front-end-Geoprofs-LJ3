...
function HeaderManager() {
  return (
    ...
    <div className="bg-[#0000ff] w-[calc(100%/3)] h-full flex">
      <div className="w-[50%] h-full bg-[#ff0000] flex justify-between">
        <button className="bg-[#20B5FF] w-[40px] h-[40px] rounded-full">stat</button>
        <button className="bg-[#20B5FF] w-[auto] h-[40px] rounded-full flex p-[5px] items-center">
