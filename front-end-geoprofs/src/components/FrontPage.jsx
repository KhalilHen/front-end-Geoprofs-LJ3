              ...
              <div className='w-3/4 h-full flex'>
                ...
                <div className='h-full w-[calc((100%/14)*3)] flex flex-col-reverse'>
                  <button
                    id='lastWeek '
                    onClick={LastWeek}
                    className='w-full h-[30px] bg-[#20B5FF] rounded-tl-[15px] text-white'
                  >
                    Vorige Week
                  </button>
                </div>
                ...
                <div className='h-full w-[calc((100%/14)*3)] flex flex-col-reverse'>
                  <button
                    id='nextWeekButton'
                    onClick={NextWeek}
                    className='w-full h-[30px] bg-[#20B5FF] rounded-tr-[15px] text-white'
                  >
                    Volgende Week
                  </button>
                </div>
            ...
            <div className='w-full h-1/2 flex'>
              <div className='w-1/4 h-full content-center'>
                <form className='justify-center flex' action=''>
                  <input
                    className='w-4/5 h-[40px] border-solid border-[#A7A7A7] border-[1px] p-[10px]'
                    type='text'
                  />
                </form>
              </div>
                ...
                <table className='h-full w-full'>
                  <tr className='h-full w-full'>
                    <td className='h-full w-[calc(100%/7)] border-solid border-[#A7A7A7] border-[1px] text-center'>
                      <div className='h-1/2 w-full text-2xl flex-col-reverse flex'>
                        Maandag
                      </div>
                      <div className='h-1/2 w-full text-2s'>
                        {ConvertMoment(weekDates[0])}
                      </div>
                    </td>
                    <td className='h-full w-[calc(100%/7)] border-solid border-[#A7A7A7] border-[1px] text-center'>
                      <div className='h-1/2 w-full text-2xl flex-col-reverse flex'>
