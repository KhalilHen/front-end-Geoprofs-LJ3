...
describe('section manger approves leave request from department manger in section self is managing', () => {
  test('receives message it was successful', async () => {
  const mockSetUser = jest.fn();
  const mockNavigate = jest.fn();
  const mockSetResponse = jest.fn();
  ...
  const input = {leave_request_id: 7, value: 2};//value 2 is accept and value 1 would be decline 
...
describe('department manger tries to approves leave request from self', () => {
  test('receives 403', async () => {
  const mockSetUser = jest.fn();
  const mockNavigate = jest.fn();
  const mockSetResponse = jest.fn();
...
describe('CEO approves leave request from section manger', () => {
  test('receives message it was successful', async () => {
  const mockSetUser = jest.fn();
  const mockNavigate = jest.fn();
  const mockSetResponse = jest.fn();
  ...
  const input = {leave_request_id: 6, value: 2};//value 2 is accept and value 1 would be decline 
...
describe('section manger tries to approves leave request from self', () => {
  test('receives 403', async () => {
  const mockSetUser = jest.fn();
  const mockNavigate = jest.fn();
  const mockSetResponse = jest.fn();
