...
function HeaderNormal() {
  ...
  return (
    <div
      ...
      className='bg-center bg-no-repeat bg-cover background-image duration-[2s] w-full h-full content-center flex flex-wrap justify-center'
    >
      <div className='bg-[#fff] w-[300px] h-[500px] border-solid border-[#A7A7A7] border-[1px]'>
        ...
        <div className='w-full h-[150px] content-center flex flex-wrap justify-center'>
          <Link
            id='my-button'
            onClick={() => console.log('button clickt')}
            className='w-4/5 h-[40px] border-solid border-[#A7A7A7] border-[1px] p-[10px] rounded-full flex justify-center'
            to='/Calander'
          >
            Log In
          </Link>
